...
Re-verified 2026-08-07 (task-20260807-071614): scan re-run independently,
still exactly 33 names; this pass also added the one real name (`EMAIL_FROM`)
that the 2026-08-02 audit found missing from the table below despite being
counted in the 33.
...
| `EMAIL_FROM` | Feature-specific | The "from" address `email.ts`'s Resend integration sends transactional email as. |
