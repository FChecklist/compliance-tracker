...
| [`docs/CONFIGURATION.md`](../CONFIGURATION.md) | 🆕 | Added 2026-08-01 (AI-Readable Configuration Documentation gap closure). Consolidated index of all 33 real `process.env.*` vars used in `src/` (only 4 were previously listed, in `CLAUDE.md`) plus notable in-code sanity-ceiling/feature-flag constants. |
