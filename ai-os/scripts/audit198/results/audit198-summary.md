...
Generated: 2026-07-21T12:11:37.777Z
...
- **PERSONALIZATION** (Per-user/per-org personalization, 2 items): PARTIALLY_ENFORCED=1, ENFORCED=1
...
- **THIN_CLIENT_DEV_ENV** (Server-only dev environment (GLM/Claude Code CLI via SSH), 1 items): ENFORCED=1
