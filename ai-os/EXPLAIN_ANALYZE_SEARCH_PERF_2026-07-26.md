...
**Migration:** `drizzle/0264_search_perf_gin_trgm_indexes.sql` (not applied
live — Tier2, Owner sign-off required).
...
`drizzle/0264_search_perf_gin_trgm_indexes.sql` adds the five indexes;
