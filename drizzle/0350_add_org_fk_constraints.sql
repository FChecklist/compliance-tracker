...
--
-- Renumbered 0315 -> 0350 during a rebase onto current main (2026-08-31,
-- replacement PR for #1288): main had advanced to 0343 by rebase time (11
-- concurrent gap-closure/rebase agents in this same batch also independently
-- claiming new numbers around the same time), so 0315 was long since taken
-- by an unrelated migration on main and even a small step past 0343 risked
-- a same-day collision with a sibling rebase agent's own pick -- jumped to
-- 0350 for headroom, re-verified against a fresh origin/main fetch
-- immediately before this file was written that nothing in 0344-0350 was
-- yet claimed by any merged migration.
--
