...
-- for an unrelated migration (0329_r63_pipeline_level_models.sql) since this
-- PR branched. Content is byte-identical to the original PR's migration
-- otherwise -- only the file name/journal entry number changed.
