...
--
-- Renumbered 0335 -> 0338 during a rebase onto current main (2026-08-30):
-- 0335 was independently claimed by 0335_crm_accounts_ai_and_bridge_
-- columns.sql (merged via PR #1475) after this branch's own merge-base
-- snapshot was taken; 0336/0337 were also claimed by real pending/merged
-- work (construction_tenders, audit_logs_session_office_stamp) by the
-- time this rebase was completed -- 0338 was the next genuinely free slot.
--
