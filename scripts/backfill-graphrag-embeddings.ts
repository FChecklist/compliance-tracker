...
// Real bug caught while writing this script's own unit test: without this
// guard, merely IMPORTING this file for its exported buildXContent()
// functions also ran the live backfill as a side effect (main() was called
// at module scope, unconditionally). Matches
// scripts/report-test-coverage-gap.mjs's own established isMain pattern.
