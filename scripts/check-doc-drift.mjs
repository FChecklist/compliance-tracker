...
// Framework, evaluation 2026-08-01, re-implemented 2026-08-15): "Automatic
// Documentation Generation" and "Documentation Accuracy" findings both point
// at the same root cause -- ai-os/system-tree/ (the architecture/DB/API/UI
// docs) is a manual, point-in-time snapshot with no mechanism that flags
// when it has drifted from the live codebase. Only API docs (a separate,
// narrower surface, src/lib/openapi/generate.ts) are truly auto-generated.
//
