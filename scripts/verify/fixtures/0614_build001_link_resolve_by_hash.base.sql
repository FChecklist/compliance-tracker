-- Base snapshot for the PGlite rollback replay (BR-207). Generated 2026-09-25T10:45:59Z by:
--   node scripts/verify/gen-base-snapshot.mjs --tables platform.user_ai_links --function compliance.current_org_id --function platform.rpc_resolve_ai_link_token
...
CREATE OR REPLACE FUNCTION platform.rpc_resolve_ai_link_token(p_token text)
 ...
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'platform', 'compliance', 'pg_catalog', 'pg_temp'
AS $function$
BEGIN
  RETURN QUERY
