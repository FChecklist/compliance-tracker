-- BUILD-002 WP-09a: this snapshot is a COPY of 0625_build001_awl_read_functions.base.sql (which holds compliance.submissions, read from the live catalog 2026-09-25).
-- The 17 live columns of compliance.submissions were re-read 2026-09-26 and equal the ones below. Regenerate with the command on the next line, from a role that can connect, when the live table changes.
