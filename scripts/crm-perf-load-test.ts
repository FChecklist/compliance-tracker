...
// drizzle/0264_v2_16_crm_perf_indexes.sql verbatim (not a re-typed copy --
...
async function main() {
  ...
  try {
    ...
    log("Applying drizzle/0264_v2_16_crm_perf_indexes.sql verbatim...");
    const migrationSql = readFileSync("drizzle/0264_v2_16_crm_perf_indexes.sql", "utf-8");
