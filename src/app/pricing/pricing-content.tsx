...
const FAQS = [
  ...
  {
    q: "Is my data secure?",
    a: "Yes. All data is encrypted in transit and at rest by our infrastructure providers. This platform is hosted on Vercel and Supabase, both of which hold current SOC 2 Type II certifications, and tenant data is additionally isolated at the database layer via row-level security. Your AI keys (if using BYOK) are encrypted separately and never shared with any third party. This platform itself does not currently hold a SOC 2 certification or an independent penetration-test report — if your organisation needs either for a vendor security review, contact our sales team to discuss your requirements.",
  },
  {
...
// (UMR-20260804-090421-c647) to /pricing, same pattern as login-form.tsx's
// `brand` prop -- resolved server-side by the async parent page.tsx. `null`
// (no host match) renders exactly what this page rendered before this
// change. Real UX audit finding (OCID-020 category 23, 2026-08-14
// evidence_json): /pricing hardcoded "VERIDIAN AI" while /login correctly
// showed the resolved brand, a severity-3 heuristic-2/heuristic-4
