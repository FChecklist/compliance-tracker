...
// Priority 17 Wave 1: gained companyId/consolidate, matching the sibling
// trial-balance/profit-and-loss/balance-sheet routes' own query-param shape.
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const report = await profitAndLossByCostCenter({ orgId: ctx.orgId }, fromDate, toDate, { companyId, consolidate })
