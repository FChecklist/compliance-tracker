...
import { listMaterials, createMaterial, ServiceError } from "@/lib/services/construction-material-service"
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = await createMaterial({ orgId: ctx.orgId }, body)
