...
// down as a plain prop, mirroring LoginForm's own contract exactly.
function MfaChallengeForm({ brand }: { brand: PreAuthBrand | null }) {
        ...
        <div className="relative w-full max-w-md px-4">
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-3 mb-4">
              ...
              <span className="font-heading text-2xl text-white">{brand?.brandName ?? "VERIDIAN AI"}</span>
            </div>
          </div>
...
export default function MfaChallengePage({ brand }: { brand: PreAuthBrand | null }) {
  return (
