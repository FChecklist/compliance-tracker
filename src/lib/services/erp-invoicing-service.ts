...
// ============================================================
// AP Reports (calculation-track engine build/extend, Group 2 --
// FI-AP-001/002/003/004 per sap_mapping.sqlite; FI-AP-005/006/007 were
// independently built and merged to main by a parallel session while this
// branch was in flight -- see computeRetentionAmount/subcontractorRetentionSummary/
// releaseSubcontractorRetention/vendorPaymentBehaviorReport/paymentProposalList
// above/below for those, this branch's own duplicate versions were dropped
// at merge time). Mirror the AR-side reports below (arAgingReport etc)
// wherever a real AR equivalent already established the pattern; each
// function's own comment says which.
// ============================================================
...
// FI-AR-002, SD-006, SD-008 per sap_mapping.sqlite -- FI-AR-006 was
// independently built and merged to main by a parallel session while this
// branch was in flight, see customerPaymentBehaviorReport above; this
// branch's own duplicate version was dropped at merge time). Mirror the
// AP-side reports above wherever a real AP equivalent already established
// the pattern (FI-AR-001/002 are the direct customer-side counterparts of
// FI-AP-001/002 built in Group 2). FI-AR-005/FI-AR-007/SD-004/SD-005 live
// in erp-selling-service.ts, next to erpCustomers/erpSalesOrders.
// ============================================================
