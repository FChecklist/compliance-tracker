...
//
// Also merged with a sibling wave's real gap-closure: crm-accounts-
// service.ts got a real owner-or-manager RBAC gate in Wave 4 (17 Jul 2026,
// canEditAccount/canReassignOrDeleteAccount/canCreateCrmRecord) but
// crm_leads/crm_opportunities -- the sibling tables one wave earlier --
// never did. Any authenticated org member, including viewer/client_viewer/
// external_auditor rank, could create/edit any lead or opportunity and
// could silently reassign ownership via a plain PATCH { ownerId } with
// zero rank check at all, through the native CRM UI's own
// /api/crm/leads* and /api/crm/opportunities* routes. This file also tests
// the pure gate functions added to close that gap.
//
