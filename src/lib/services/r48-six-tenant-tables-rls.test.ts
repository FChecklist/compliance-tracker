...
// pcrjmlpuqsbocqfwoxod), then added a migration to bring this repo's
// migration history in sync with that live state -- same technique PR
// #1397 used for CRR-068 (drizzle/0327_crr_p2_schema_drizzle_sync.sql).
// Renumbered 0329 -> 0334 during this session's PR-backlog reconciliation
// pass (2026-08-30, original PR #1439): main had independently claimed 0329
// for an unrelated migration since this PR branched.
//
...
const migrationPath = join(import.meta.dir, "..", "..", "..", "drizzle", "0334_r62_b7_rls_six_tenant_tables_sync.sql")
