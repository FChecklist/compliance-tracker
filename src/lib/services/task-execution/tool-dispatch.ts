// dispatchTool(): the read-only global-agent dispatcher. Split out of
// task-execution-engine.ts for size/responsibility reasons (that file was
// ~2583 lines) -- purely mechanical extraction, no behavior change. See
// task-execution-engine.ts's own module-level doc comment (above its
// re-export of dispatchTool) for the full context this function operates
// within (Wave 4's task-execution engine, read-only-auto-dispatch posture,
// etc).
