...
const migrationPath = join(import.meta.dir, "..", "..", "..", "drizzle", "0268_sales_pipeline_dashboard_targets.sql")
const migrationSql = readFileSync(migrationPath, "utf8")

describe("compliance.crm_sales_targets RLS (drizzle/0268_sales_pipeline_dashboard_targets.sql)", () => {
