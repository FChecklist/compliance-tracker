...
// never matched this repo's own branch-naming convention. That branch/path
// gate worked (proven live: every non-main preview it saw was BLOCKED) but
// required a throwaway git-fixture harness to exercise, and treated "main"
// specially by literal string rather than by Vercel's own notion of which
// deployment is the production one.
//
