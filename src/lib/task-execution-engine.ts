...
// this file's own two largest, most self-contained responsibilities --
// structured tool dispatch and VCEL calculation-engine dispatch -- now
// live in src/lib/services/task-execution/ as their own modules (see each
// file's own header for why). dispatchTool is re-exported below (this
// file's own public API contract, per its external callers); dispatchEngine
// is used only internally, by executeEngineDispatch further down.
