...
import { generateForm26QReport, ServiceError } from "@/lib/services/tds-return-service"
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const report = await generateForm26QReport({ orgId }, financialYearStart, quarter)
