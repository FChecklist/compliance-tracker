...
export default function UsersPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Invite Modal -- shared with the persistent "+" control in
          AppTopbar (U-D28); both drive POST /api/users. */}
      <InviteUserModal open={showInvite} onOpenChange={setShowInvite} onInvited={loadUsers} />
    </div>
  );
}